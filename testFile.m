...
Gamma = zeros(size(changeZoneId));
Gamma(1,1) = (1/183)*(1/2);
for a=2:1:length(changeZoneId)
    Gamma(a,1) = TRANSITION_P_NORM(changeZoneId(a-1,1),changeZoneId(a,1)) * DELTAT_P_NORM(changeZoneId(a-1,1),changeZoneId(a,1),quantizedTime(a-1,1)) * Gamma(a-1,1);
end
